## roch_simulator (kinetic) - 2.0.12-5

The packages in the `roch_simulator` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic roch_simulator` on `Mon, 18 Sep 2017 05:37:44 -0000`
...
- old version: `2.0.12-4`
- new version: `2.0.12-5`
...
## roch_simulator (kinetic) - 2.0.12-4

The packages in the `roch_simulator` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic roch_simulator` on `Mon, 18 Sep 2017 05:23:46 -0000`
...
- release repository: unknown
- rosdistro version: `null`
- old version: `2.0.12-3`
- new version: `2.0.12-4`
...
## roch_simulator (kinetic) - 2.0.12-2

The packages in the `roch_simulator` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic roch_simulator --override-release-repository-url https://github.com/SawYerRobotics-release/roch_simulator-release.git` on `Mon, 18 Sep 2017 04:51:04 -0000`
...
## roch_simulator (kinetic) - 2.0.12-1

The packages in the `roch_simulator` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic roch_simulator` on `Mon, 18 Sep 2017 04:41:21 -0000`
...
## roch_simulator (kinetic) - 2.0.12-0
